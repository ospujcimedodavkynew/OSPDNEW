        ...
        <Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <select id="vehicle" value={selectedVehicleId} onChange={e => setSelectedVehicleId(e.target.value)} className="shadow-sm appearance-none border border-border rounded w-full py-2 px-3 text-text-primary leading-tight focus:outline-none focus:ring-2 focus:ring-primary">
                ...
                <div>
                    <Label htmlFor="customer">Zákazník</Label>
                     <select id="customer" value={selectedCustomerId} onChange={e => setSelectedCustomerId(e.target.value)} className="shadow-sm appearance-none border border-border rounded w-full py-2 px-3 text-text-primary leading-tight focus:outline-none focus:ring-2 focus:ring-primary">
